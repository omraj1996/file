					...
					while($row = mysql_fetch_array($result))
						{
							...
							?><a href="notify.php?id=<?php echo $row[0];?>" class="button">Delete</a><?php
						}
			?>
...
</div><div id="footer" align="center"><a href="#">Om Raj &copy 2017</a></div>
</body>
</html>
<?php
...
$qry="delete  from noticemsg where id='$g'";
echo $qry;
mysql_query($qry);
