...
if(isset($_SESSION))
{
		...
		mysql_select_db("om");
		$sql=mysql_query("Select * from loginmaster where userid='$userid'");
...
.navbar-xs { min-height:40px; height: 40px; background-color:; }
...
<nav class="navbar  navbar-inverse  ">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">CSE Portal</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="studentin.php">Home</a></li>
